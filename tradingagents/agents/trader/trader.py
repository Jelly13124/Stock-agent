...
def create_trader(llm, memory):
    def trader_node(state, name):
        ...
        market_research_report = state.get("market_report", "（未执行市场研究分析）")
        news_report = state.get("news_report", "（未执行新闻分析）")
        fundamentals_report = state.get("fundamentals_report", "（未执行基本面分析）")
        ...
        context = {
            "role": "user",
            "content": f"Based on a comprehensive analysis by a team of analysts, here is an investment plan tailored for {company_name}. This plan incorporates insights from current technical market trends, macroeconomic indicators. Use this plan as a foundation for evaluating your next trading decision.\n\nProposed Investment Plan: {investment_plan}\n\nLeverage these insights to make an informed and strategic decision.",
        }
